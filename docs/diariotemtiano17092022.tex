...
\hypersetup{
  pdftitle={Diario Temtiano edición 17.09.2022},
  pdflang={es-es},
  hidelinks,
...
\title{Diario Temtiano edición 17.09.2022}
\author{}
\date{\vspace{-2.5em}2022-09-17}
...
Especiales gracias a los tantos sitios (Temti.net, Arged.ga, Voxed.club, Tsubit.com, Rouzer.fun, Oldtemti.herokuapp.com, Grupostemti.herokuapp.com, Rouzed.one, Fantemti.herokuapp.com, Fantemti.up.railway.app), a sus administradores, moderadores, y usuarios, que le permitieron a Diario Temtiano tener un lugar para difundir sus novedades.
