...
\hypersetup{
  pdftitle={Diario Temtiano edición 07.12.2022},
  pdflang={es-es},
  hidelinks,
  pdfcreator={LaTeX via pandoc}}

\title{Diario Temtiano edición 07.12.2022}
\author{}
...
Especiales gracias a los tantos sitios (Temti.net, Arged.ga, Voxed.club, Tsubit.com, Rouzer.fun, Oldtemti.herokuapp.com, Grupostemti.herokuapp.com, Rouzed.one, Fantemti.herokuapp.com, Fantemti.up.railway.app, Boxed.fun), a sus administradores, moderadores, y usuarios, que le permitieron a Diario Temtiano tener un lugar para difundir sus novedades.
