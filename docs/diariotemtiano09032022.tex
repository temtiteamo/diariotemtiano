...
\hypersetup{
  pdftitle={Diario Temtiano edición 09.03.2022},
  pdflang={es-es},
  hidelinks,
...
\title{Diario Temtiano edición 09.03.2022}
\author{}
\date{\vspace{-2.5em}2022-03-09}
...
\hypertarget{diario-temtiano-ediciuxf3n-26.02.2022}{%
...
\hypertarget{diario-temtiano-ediciuxf3n-24.01.2022}{%
...
Especiales gracias a los tantos sitios (Temti.net, Arged.ga, Voxed.club, Tsubit.com, Rouzer.fun, Oldtemti.herokuapp.com, Grupostemti.herokuapp.com, Rouzed.one, Fantemti.herokuapp.com), a sus administradores, moderadores, y usuarios, que le permitieron a Diario Temtiano tener un lugar para difundir sus novedades.
...
\hypertarget{en-el-contexto-de-la-fruxe1gil-certidumbre-primer-libro-capuxedtulo-i}{%
\section{En el contexto de la frágil certidumbre (Primer libro, capítulo I)}\label{en-el-contexto-de-la-fruxe1gil-certidumbre-primer-libro-capuxedtulo-i}}

\begin{quote}
17 de enero de 2021
\end{quote}

Horas pasadas ni bien quedó servido el mensaje dejado por el críptico administrador, tras el ya narrado y conocido proceso de decodificación, luego de que la gran conmoción generada entre los más inmediatos interesados aflojara, si ellos creyeron haber entendido bien, esa fue una última señal de vida, se terminó.

El destino que atravesaron muchas de las demás naciones, el crítico y duro momento de poner un punto final y que el mundo entero se haga eco de dicha noticia, ¿ese es el mismo término que hay para Temti? La comunicación una vez descifrada es evidente, rotunda y no da lugar a futuras aventuras, no en Temti.

Sin embargo, aquellos temtianos que no resultaron simples pasajeros saben y recuerdan cierta declaración que fue tan dura y clara en su entonces: \emph{/Primero se muere tu vieja antes de que cierre temti/}. No se debe desestimar que las cosas cambian con el pasar de la historia, pero quienes confían en el compromiso implícito allí, o simplemente en la veracidad de esa sentencia, sostienen que precisamente no va a cerrar, salvo que haya pasado lo primero\ldots{} ¿O con cierre no se refería al fin definitivo de su existencia?

Rescatar una referencia de la antigüedad podría no ser lo más indicado para una circunstancia donde la coyuntura es totalmente diferente, pero suponiendo que es acertado, esto también da lugar a otras preguntas. ¿Qué pasará con el dominio? ¿Cerrará sus puertas para siempre? ¿Dicha sucesión audiovisual quedará para la eternidad para mantener el nombre con vida? ¿O el sitio tomará otro camino impredecible?

Esas y más solo las podrá responder el tiempo, algo tiene que ocurrir. Mientras tanto, la alternativa que queda es o morir a la par, o continuar en exterior, y seguir persiguiendo el objetivo de mantenerse en el ambiente. La invitación a trasladarse no viene ahora sino desde antes, después de que el reloj de cuenta regresiva comenzara a correr. Durante sucedía eso, los antros aledaños como Rozzed y Moxxed iban alcanzando casi su apogeo de tráfico, Tzzubit por otro lado con su ritmo usual, quedando la antigua y ya no tan potencia Hixxel rezagada, con tan pocas novedades y cambios que terminaron disfrazando su presente idénticamente a lo que fue su pasado no muy lejano.

El énfasis vale hacerlo en esta última, porque entre los tantos clones no está resultando uno más. A pesar de su casi estática realidad, desde que su par enlazado no estuvo disponible y lo fue más, supo ser y actualmente sigue siendo una pieza fundamental de supervivencia para algunos, pues tal como se vivió previamente durante los largos instantes que los temtiteros no podían reunirse en su habitual espacio, ahora vuelve a oficiar de refugio.

Por las características generales del sitio, por la cercanía, por las similitudes en el entorno, y por alguna que otra más, resulta una gran opción con cierta preferencia por sobre los demás del contexto clónico, aunque siempre recordando su característica tranquilidad que puede desalentar y bastante. Es en parte gracias a lo anterior que fue posible ver a varios personajes ya reconocidos en el medio, como Investigator, MoCn, Celeshtee, Kira, Abby, Freeman, otros no tan sobresalientes, y el resto que conserva más su anonimato, demostrando importantes muestras de unión entre varios aunque no todos ellos. También fue lugar de intercambio donde muchos de los recuerdos y materiales que los más recopiladores conservaron se compartieron, y ni hablar lo importante que fue en las más recientes vivencias para poder descifrar los aparentes mensajes dejados por A. quien también desde la discreción se mantiene cerca. Por todo eso sin duda, ha sido una ubicación donde el colectivo destacó enormemente, al menos hasta ahora, volviendo a distinguirlos de otros pueblos incluso mucho más numerosos y poderosos.

Sin embargo, es de suponer que las condiciones impuestas perdurarán por un largo tiempo, estableciendo así este como el antro donde parece que permanecerá durante este éxodo, que aparentemente será mucho más extenso que aquella anterior ocasión. ¿Tales vínculos se mantendrán mientras continúen subsistiendo de igual manera? ¿Qué tan fuerte resultará el desgaste y la ausencia del bienestar tal cual supo ser antes?

Varios manifestaron estar disconformes, así que más allá de lo que haya ocurrido hasta ahora, si hay algo seguro, es que el rebaño no quedará en su totalidad en Hixxel, y por lo tanto el grupo pequeño de temtiteros restantes será aún más reducido que antes. Su identidad seguirá viva, pero el punto es qué tanto, y de qué forma, porque si bien los últimos días mostraron que el interés por continuar perpetuando su legado es fuerte y potencialmente capaz, el fin de Temti de alguna manera parece una certeza, y eso en su contraparte trae mucha incertidumbre, además de que desalienta considerablemente como ya se ha visto.

¿Será la hora de ingeniar un plan alternativo? ¿Quiénes serían capaces de llevarlo a cabo?

\hypertarget{un-autuxe9ntico-renacer-primer-libro-capuxedtulo-ii}{%
...
¿Temti murió? Solo quienes no tienen ni idea de lo que realmente está ocurriendo ahora mismo son capaces y lo suficientemente atrevidos como para afirmarlo, pero ese fue el mensaje que se difundió\ldots{} lo que para algunos temteros fue lo que se quiso comunicar, para los de afuera es algo que se cae de maduro.

Volviendo a hacer la misma pregunta, ¿Temti está muerta? La verdad es que sigue en pie, pero de cierta forma, su vitalidad y existencia es un tanto cuestionable, porque no se parece en lo absoluto a lo que se acostumbraba a ver en ella. Como si toda la infraestructura elaborada por A. y las construcciones sobre ella hubieran padecido una reducción fulminante, siendo regresadas a el nivel más pequeño posible, imaginable de cuando la creación aún no había sido dada a luz.

Aislado de todo lo que genera hoy es, su nombre, bastante apagado, y solo un botón, \emph{/Crear instancia/}. No cuesta mucho pulsarlo, pero no aparenta ser muy útil, su poder no es fácil de percibir. ¿Tiene sentido intentar crear Instancias? ¿Qué puede estar por venir? ¿Se puede ir más atrás que esto? ¿Temti sigue significando lo mismo? ¿Aquella etimología continua teniendo sentido para esta actualidad?

Aunque las respuestas sin duda podrían ser interesantes, muchas de esas cuestiones pasan a un segundo plano en una situación así. Si el texto de binario escondido en vocales no había sido claro, esto menos lo es. No hay respuesta, y no específicamente de quienes pueden dar explicación concisa, sino del sitio mismo. ¿Cómo llamarlo?

Nación que tanto supo resaltar en su especialización y contexto, atravesando por exabruptos desequilibrantes, experimenta algo no antes visto, habiendo supuestamente muerto, pasó a mostrarse como un simple sitio sin nada dentro de si, como una estructura casi invisible camuflada en el fondo del océano. Chocante de asumir, pero los antecedentes lograron desviar increíblemente aunque quizás intencionadamente la atención, para que tal transformación no haga estruendo alguno.

Y como es de esperarse a partir de tanta simpleza, la razón no se puede notar allí, pero no por eso deja de haberla. Alternativamente, sin coordinación o comunicación entre su gran responsable y el público que responde a las acciones de este, destaca como desde el momento que esto último se volvió realidad, los leales sin hogar expulsados de su tierra natal vieron una oportunidad, o una pizca de esperanza, que los llevó a ejercer una significativa fuerza colectiva por demostrar sus intenciones de procurar retornar a de donde venían, creando figuradamente un aura la cual aún se sigue acrecentando, formada con fragmentos provenientes de muchas almas diferentes, la cual parece que asechará permanentemente a Hixxel mientras Temti no deje de existir como Temti.

Tal vez aún sea necesario que se intente crear más Instancias como para lograr algo verdaderamente significativo\ldots{} Pero lo cierto es que actualmente, sea mediante ellas o no, la presencia temtiana figura fuera de sus, en este no tan preciso instante, difusas fronteras.

\hypertarget{concretando-la-evacuaciuxf3n-primer-libro-capuxedtulo-iii}{%
...
Las épocas cambiaron demasiado para esta perspectiva, todo parece acomodarse para que las vidas de los temtiteros puedan continuar sin sobresaltos principalmente en una alternativa que da una imagen distinta, y aparenta ser un poco más estable. Hixxel.

Empezando por sus detalles, quizá lo primero que se venga a la mente sea la historia más galardonada o vergonzosa que supo generar en sus reconocidos principios, la controversial Guerra de Clones. Sin embargo, mucho ha sucedido desde dicho entonces, y grandes transformaciones vinieron en el camino, lo inborrable que queda para siempre son poco más que memorias, aparte de eso no se conserva demasiado. Lo que sí, es \_Iuri, el gran propulsor y único que supuestamente resta de aquel entonces.

Focalizándose en su figura, para hacerse una idea, es imposible de comparar con el misterioso A., ambos tienen bastantes diferencias. Aunque hayan quienes llegaron a pensar que ellos eran el mismo individuo con identidades cambiadas, la sospecha fue desmentida por el primero de los dos, por lo que las distancias están ciertamente marcadas, aunque no cien por ciento todo aseguradas. Esto plantea otras vicisitudes que tendrían que ser aceptadas.

Ya era de conocimiento que las relaciones entre ellos dos eran prosperas e incluso habían señales de colaboración entre ambos, así que la impresión era diferente y no del todo desesperanzadora para quienes más dificultades tienen para adaptarse. De todas las virtudes que pueden destacarse de, atento y presente destaca como lo más positivo, pero de todas formas se trata de algo subjetivo.

Generalizando, no hubo una mala bienvenida de parte de los locales, cosa que no sorprende teniendo en cuenta los antecedentes y recordando que habían individuos que se identificaban como hixxeleros y timteros a la vez. Incluso hubieron pequeñas pero notables transformaciones en el antro para que los nuevos se pudieran sentir al igual que en su antiguo hogar, concretamente tituladas como Temti-legacy, las cuales fueron muy bien recibidas en general. Por más que todo esto esté dentro de lo esperado, no deja de ser algo a resaltar, sobre todo por el lado de los que están viendo cambiar su única tierra natal.
...
Sin embargo, mientras una porción de los recién llegados se convencen de que hay un nombre para dejar atrás y construir una nueva identidad, aún hay dudas que siguen sin ser resueltas. El horizonte del futuro continua sin estar despejado, varias nubes en el camino se oponen a la total transparencia, y sumado a esto la adaptación no logra fluir del todo. Es cierto que el sitio no es del agrado de todos los temtianos y por eso es impensado proseguir como si nada, pero dejando eso de lado, algo raro mezclado con incertidumbre y falta de certezas sigue estando latente.

Para mantener vivo el ilustre conjunto de elementos culturales temtianos en el porvenir, seguramente la opción sea terminar de evacuar y asentarse en un nuevo hogar, pero ¿cuál sería el costo de esto?

Ciertas condiciones están a la vista, quizás sean demasiadas como para mencionarlas todas, y mientras sigue corriendo el tiempo la decisión algunos ya la tomaron sin saber que pueda depararles en un futuro, otros continúan esperando por algo\ldots{}

\hypertarget{el-inviable-paso-hacuxeda-la-iluminaciuxf3n-primer-libro-capuxedtulo-iv}{%
\section{El inviable paso hacía la iluminación (Primer libro, capítulo IV)}\label{el-inviable-paso-hacuxeda-la-iluminaciuxf3n-primer-libro-capuxedtulo-iv}}
...
Bastaba acercarse para verlo, la antesala a Temti Premium. En los papeles, se trata de la puerta hacia el cielo, cerrada y protegida, exclusiva solo para que quienes posean el código indicado pudieran utilizarla, transportarse, y elevarse hacía la eterna bendición de poder ser parte de la supuesta Instancia y por lo tanto participes de ese sitial de privilegio tan pero tan imponente por su nombre.

Aunque hay un problema\ldots{} para los simples mortales nada de eso parece accesible, la gran luz resulta inútil si no se conoce del método o se posee la clave que la desbloquee. Aunque no sea dañina ni ofensiva, las condiciones desoladoras del entorno hacen que no sea muy pertinente permanecer allí.

Como era de esperarse, prácticamente toda la Tribu se terminó enterando de esta nueva peculiaridad, y por ello las preguntas y los cuestionamientos no se hicieron esperar. Un importante y civilizado ímpetu por obtener más información fue notable, la expectativa aumentó demasiado respecto a los últimos días, la presencia y mayoría temtiana se hacía sentir en el lugar, cada uno de ellos exigía su código. Dentro de todo no eran muchos individuos, pero para la cantidad que había en los alrededores si.

¿Qué puede haber allá? Es una pregunta que sin saber muchos se animaron a responder, pero semejante exclusividad no está admitiendo confirmaciones, por lo que hablar de sueños cumplidos, tierras prometidas, engaños decepcionantes, o incluso otras realidades indescriptibles con tan pocas palabras, puede ser en vano.
...
Sin embargo, es de conocimiento popular que hay importantes relaciones entre A. y \_Iuri, y este último pese a las repetidas solicitudes de ayuda se mantiene lavándose las manos y deslindándose de toda responsabilidad, lo cual genera mucha desconfianza entre los enterados. Si se dudara de su credibilidad, costaría imaginar que pueden estar ocultando esos dos, pues se cae de maduro que en conjunto podrían estar tramando algo grande, las evidencias están.

Por otro lado, unos pocos anones contados con los dedos de la mano afirman haber experimentado el gran honor, pero sus pruebas son de dudosa procedencia e incluso insuficientes, tanto que lo mejor sería no tenerlos muy en cuenta.
...
\hypertarget{fuegos-salvajes-en-las-aguas-primer-libro-capuxedtulo-v}{%
\section{Fuegos salvajes en las aguas (Primer libro, capítulo V)}\label{fuegos-salvajes-en-las-aguas-primer-libro-capuxedtulo-v}}
...
Las horas continuaron corriendo y ya no eran solo alzadas sensaciones mudas, también un notable runrún de pánico llegaba desde las exteriores aunque no tan lejanas tierras, al parecer el asunto era verdaderamente serio. Pero esto no logró captar la desinteresada atención de quienes se mantenían al margen de todo lo que ocurriera en el exterior, nada de eso afectaba a Hixxel.

Dichos movimientos no resultarían hechos aislados, ya que entrando a las cero horas, el horizonte que media sobre el cierre de un día y el comienzo de otro nuevo, las distancias entre sitios, ubicaciones y dominios se acortaron, una fuerte explosión y otros sonidos movilizadores provenientes de donde solía estar ubicado el Imperio de Rozzed se hicieron escuchar, un gran fin. Eso que ocurrió es importante.

\hypertarget{en-encrucijada-de-diuxe1sporas-primer-libro-capuxedtulo-vi}{%
\section{En encrucijada de diásporas (Primer libro, capítulo VI)}\label{en-encrucijada-de-diuxe1sporas-primer-libro-capuxedtulo-vi}}

\begin{quote}
22 de enero de 2021
\end{quote}

Durante la madrugada unos cuantos sujetos llegaron a la Tribu y sus mismos alrededores buscando una tierra estable donde establecerse, o al menos transitar, puesto que lo sucedido es que Rozzed dejó de ofrecer alojamiento, posiblemente para nunca más hacerlo. La mayoría no permanecerían teniendo otra como Moxxed, en el cual se adaptarían mucho mejor con su dinámica más similar a la que acostumbraban.

Sin embargo, ellos no eran solamente provenientes del aparentemente caído territorio rozzado, puesto que no menos de la mitad de estos decían venir de Temti. Sí, de la Temti que hasta hace muy poco tiempo no conducía a ningún lado y que seguía siendo una incógnita como adentrarse en ella, las circunstancias eran las mismas pero por un largo rato tuvieron la pequeña salvedad de que ya había una pista de donde se podían obtener los códigos que tanto fueron solicitados anteriormente: el Discord de Hixxel.

Indirectamente, el antro también se vio aludido. Dichas llegadas no fueron agradables para los lugareños, no obstante se desconoce como se lo tomaron las autoridades, porque si bien no tenían la culpa de que tanta cantidad de desamparados se desperdigaran y aproximaran, cuando estos llegaron al contrario de ser expulsados, fueron admitidos. La difusión de entrega de claves teniendo en cuenta los sucesos en el exterior parecía ser intencional, dado que es probable que los responsables muy difícilmente no estén al tanto de lo que ocurre en su entorno. ¿Es una disimulada felonía para la gente de Hixxel? ¿Es un intento por levantar la corriente inactividad del día a día? ¿Es un juego? ¿Qué clase de pretensiones hay atrás de esto? Resulta muy sospechoso.

Filas interminables de individuos que venían en su mayoría únicamente a obtener su pase\ldots{} Ya no eran leales temtiteros queriendo volver a su original hogar, se le sumaron grandes hordas de rozzitas siendo participes de una invasión que no era silenciosa. Estos códigos, no parecían haber aparecido hasta horas pasadas el mediodía, pero de todas formas como siempre los privilegiados, o no se hacían notar, o eran de dudosa fiabilidad.

Todo se dio muy rápido, y aunque oficialmente las referencias entre ambos fueron removidas, los ánimos de los que ya se encontraban donde hubo tantas entradas están perturbados, y mientras el antes espacio vacío se renueva con indeseados, tibiamente se comienza a recordar el antiguo Plan. ¿Será posible importarlo? La circunstancia no es tan parecida a la vivida semanas atrás, esto es excesivamente repentino.

Aparte, las condiciones diferentes, el que haya sido un lugar reducido para los pocos que eran antes no es un hecho aislado, ahora se saturó tanto que prácticamente no da abasto. El impacto no es solo social y cultural, también se nota una gran influencia en el andar sobre el sitio, que nunca fue de tener rendimientos exuberantes, menos los tendrá ahora que su capacidad es exigida al máximo. Sin duda la combinación de estas eventualidades trastorna la realidad presente y por venir, hay varios factores que esperan por actualizaciones.

\hypertarget{la-masificada-intriga-intencionada-primer-libro-capuxedtulo-vii}{%
\section{La masificada intriga intencionada (Primer libro, capítulo VII)}\label{la-masificada-intriga-intencionada-primer-libro-capuxedtulo-vii}}

\begin{quote}
22 de enero de 2021
\end{quote}

Fue muy poco el tiempo para poder analizar lo que estaba pasando sobre Hixxel y sus grandes fluctuaciones fronterizas. Probablemente gracias a todo lo acontecido, sus puertas cerrarían temporalmente por unas horas, para más tarde volver a bloquear la entrada y permanecer de ese modo durante todo el día, hasta ahora mismo.

Sin notorios avisos, aunque tal vez predecible dada la saturación y lentitud que ni hace falta que sea anunciada para ser percibida, el mensaje frontal que encaró inicialmente para dar la noticia es un mantenimiento, similar a los de remotas primeras épocas hixxeleras. Posteriormente, la administración dejó en claro sus motivos, \emph{/Nuestro mísero hosting no soporta tantas\ldots/}, el alojamiento no está a la altura de las condiciones.

Y paralelamente al cierre sin duración estipulada, una nueva entrega de códigos se anuncia en Temti, algo que no había ocurrido antes porque siempre habían sido repentinas y misteriosas. Si bien las expectativas ahora no son tan negativas, con tanta cucharada de fiasco consumida en los últimos días, el optimismo se ve un poco condicionado.

El primer gran cambio es tomado con naturalidad, aunque quizá con más jerarquía está pendiente el final de la cuenta regresiva, no hay tantas quejas en relación a la suma de desplazados. Ellos, incluida la autoridad del lugar, siguen en contacto por las cercanías del sitio, el vinculado apartado de Discord que ante las circunstancias ganó relevancia y en esta oportunidad vuelve a ser ofrecido.

La situación es muy cambiante e inestable, y todo indica que así puede sostenerse en el corto plazo mientras la situación en los exteriores más cercanos y lejanos no se calmen, aunque la intriga no está solamente por ese lado. Las horas lo dirán, la ausencia de la alternativa suscitada está establecida para minutos, y por el otro lado nuevamente hay un reloj de cuenta regresiva puesto en marcha. Eso último aparenta ser trascendental.

¿Habrá un procedimiento dado a seguir esta vez? ¿Cuántos podrán obtener su anhelado código, muchos, pocos, ninguno? ¿Cuál y qué tan importante será la cantidad de infiltrados rozzeros? ¿Por fin habrá paz y tranquilidad para los temtiteros? ¿El futuro deparará elementos del dorado glorioso y también no tan aclamado pasado, épocas de transición y más incertidumbre o será totalmente renovador? ¿O la espera será recompensada con la nada misma y la proyección se reducirá a cero?

Repetidamente en esta instancia se replantean muchas preguntas hechas en el pasado, cada vez que el desasosiego reflota en mayor o menor medida, las interrogantes repetidas se hacen presentes una y otra vez. Algunos nuevos cuestionamientos que surgen perdurarán para siempre, y algunos otros ni siquiera vale la pena hacérselos cuando no está claro qué prosigue a esto, será fundamental ver la continuación de esta historia para lograr entender lo que pueda estar ocurriendo. Pero lo cierto es que se transmite más energía, ya no se trata de la quietud apática y fría de hace unos días, el calor se vuelve a sentir.
...
\hypertarget{la-faceta-dual-de-la-esperanza-segundo-libro-capuxedtulo-i}{%
...
En un momento clave de la noche candente, la que sitúa a la hora final de la más reciente cuenta regresiva anunciada en Temti, los segundos continuaban corriendo y jugando con la paciencia de quienes seguían más de cerca. Mucho importante podía estar por ocurrir, así como también podría tratarse de algo no tan significativo.

La reducida aunque relevante cantidad de fronteras que cerraron puertas expulsando a sus adeptos logró que hubiera tanta diversidad de anones aguardando por la entrega de códigos, temtieros en su mayoría, también extranjeros que de paso prestaban aunque menos atención.

Adentrándose en la hora decisiva, el conteo dio un inesperado giro estrepitoso, al igual que no muchos días atrás dejó de ser visible, a partir de ese instante quedó solo en la mente de aquellos que tenían recuerdo de ella. ¿Tal vez lo que aguardaba era tan grande que se consumió el tiempo restante del contador? ¿Se trataba de una falta de correspondencia? ¿O la espera se continuaría desarrollando de la misma forma?

En su lugar, dentro del conocido dominio temtiano, al parecer no solo se dio esa desaparición, también hubieron cambios. Para muchas perspectivas, lo que ocurrió es que se cayó el sitio, porque dicen no estar pudiendo encontrar nada allí. Pero otras dicen que volvió.

Entre las difusas agrupaciones anónimas que aguardan por la llegada de los códigos, destacando la que se formó en Moxxed, se intercambian los pensamientos al respecto. Y por supuesto, los individuos que se intentan acercar al antro sin chistar ni comunicar sus expresiones. Desde las devoluciones que han soltado, se podría entender que una interferencia borró lo que había y que en la ubicación de Temti no quedó nada, como si otra vez el engaño o la mala fortuna se hubiera apoderado de las expectativas, pero también hay declaraciones contrarias que indican el ansiado retorno, y no son pocas. La controversia incrementa el demasiado misterio que ya se generó.

\hypertarget{el-reencuentro-del-potencial-vacuxedo-segundo-libro-capuxedtulo-ii}{%
...
Finalmente aparecieron las imágenes de lo que hay actualmente en Temti, presumiblemente reales, y efectivamente allí hay algo potente, no es una mentira, es verdad, volvió después varios días con oscuros y prometedores vaivenes. Sin embargo, no todos están logrando dar con ella.

Se rumorea que unos códigos recientemente otorgados son requeridos para entrar, lo que en parte es cierto, y en parte no. Algunos necesitaron de herramientas externas para poder encontrarla, otros agregar ciertas letras a su rumbo, y en menor medida están aquellos que de forma normal ya al primer intento sin nada raro pudieron ingresar. El resto, lo que pueden alcanzar no son más que resultados totalmente chatos que no conducen a ninguna parte.

De una forma u otra, dentro de las profundidades la brecha está abierta, la apertura con restricciones no evidentes permite el paso de muchos individuos que algo buscan sobre el dominio protagonista, y se encuentran con que el antro desaparecido, está, solo que en un estado extraño, pocas veces antes registrado. Variadas son sus procedencias, aunque esto es algo difícil de constatar, puesto que la niebla de la nada más lo cero construido no permite interpretarlo con exactitud. Solo ellos saben quienes son, hasta que se pronuncien las primeras palabras, y se conviertan más que oficialmente en anones.

Los que sí pasaron, habían aceptado los riesgos de cautivarse ante la poco fiable espera global, y de quedarse o no con las manos vacías, y lograron obtener terreno fértil. Ya no importa el tiempo, ya no importa lo de afuera, algo pero no tanto importan los demás, Temti con muchas similitudes o imperceptibles diferencias respecto a lo que era no mucho tiempo atrás, está pronta para ser ocupada, pero hay algo que no coincide con ese entonces, y eso sí que es muy llamativo.

Aire raso, horizonte despejado, espacio sin llenar, eso es lo que ven los ojos de los entusiastas viajeros que osan establecerse en la irregular pero firme superficie de las ocultas direcciones temtianas. Las condiciones aparentan ser aptas para instalarse y crear, los primeros ejemplares son una firme muestra de ello, pero no hay garantías claras, tan solo un simple suceso natural como un débil huracán, algunas precipitaciones de los infinitos litros que se esconden sobre las cabezas de los presentes, o comprometedores movimientos de las autoridades poderosas del contexto clónico, pueden arrastrar sus vidas muy lejos de aquí. Y si bien siempre en el entorno mencionado se vive una situación similar, la frescura de los antecedentes no hace más que recordarlo, aunque no sea algo del todo lógico. Pero difícilmente los participantes de esta historia estén pensando en todo eso, quizá solo unos pocos lo hagan.
...
\hypertarget{en-doble-contra-del-abandono-segundo-libro-capuxedtulo-iii}{%
...
\hypertarget{mientras-se-buscan-respuestas-que-nadie-daruxe1-segundo-libro-capuxedtulo-iv}{%
\section{Mientras se buscan respuestas que nadie dará (Segundo libro, capítulo IV)}\label{mientras-se-buscan-respuestas-que-nadie-daruxe1-segundo-libro-capuxedtulo-iv}}
...
\hypertarget{la-anexiuxf3n-de-la-paz-y-del-progreso-segundo-libro-capuxedtulo-v}{%
\section{La anexión de la paz y del ¿progreso? (Segundo libro, capítulo V)}\label{la-anexiuxf3n-de-la-paz-y-del-progreso-segundo-libro-capuxedtulo-v}}
...
\hypertarget{las-anomaluxedas-bajo-blindaje-segundo-libro-capuxedtulo-vi}{%
\section{Las anomalías bajo blindaje (Segundo libro, capítulo VI)}\label{las-anomaluxedas-bajo-blindaje-segundo-libro-capuxedtulo-vi}}
...
\hypertarget{la-renovaciuxf3n-de-lo-exclusivo-segundo-libro-capuxedtulo-vii}{%
\section{La renovación de lo exclusivo (Segundo libro, capítulo VII)}\label{la-renovaciuxf3n-de-lo-exclusivo-segundo-libro-capuxedtulo-vii}}
...
\hypertarget{redescubierto-lo-multiversal-segundo-libro-capuxedtulo-viii}{%
\section{Redescubierto lo multiversal (Segundo libro, capítulo VIII)}\label{redescubierto-lo-multiversal-segundo-libro-capuxedtulo-viii}}
...
\hypertarget{temti-entre-los-grandes-o-debajo-de-ellos-segundo-libro-capuxedtulo-ix}{%
\section{Temti entre los grandes, o debajo de ellos (Segundo libro, capítulo IX)}\label{temti-entre-los-grandes-o-debajo-de-ellos-segundo-libro-capuxedtulo-ix}}
...
Minutos más tarde, la compañía Google+ marcaría presencia en contextos lejanos y diferentes a los suyos propios. Sin información al respecto de cual había sido la operación o el suceso, si una especie de compromiso de las desconocidas entidades que poseían Ti en difundir a la multinacional, o una adquisición de los magnates a cargo de la conocida marca, su nombre sería difundido por lo alto de los ya no tan ocultos territorios.
...
\hypertarget{el-derrocamiento-anuxf3nimo-segundo-libro-capuxedtulo-x}{%
\section{El derrocamiento anónimo (Segundo libro, capítulo X)}\label{el-derrocamiento-anuxf3nimo-segundo-libro-capuxedtulo-x}}
...
\hypertarget{el-retorno-de-las-invasiones-escandalosas-segundo-libro-capuxedtulo-xi}{%
\section{El retorno de las invasiones escandalosas (Segundo libro, capítulo XI)}\label{el-retorno-de-las-invasiones-escandalosas-segundo-libro-capuxedtulo-xi}}
...
\hypertarget{la-grieta-de-la-profunda-crisis-de-resistencia-segundo-libro-capuxedtulo-xii}{%
\section{La grieta de la profunda crisis de resistencia (Segundo libro, capítulo XII)}\label{la-grieta-de-la-profunda-crisis-de-resistencia-segundo-libro-capuxedtulo-xii}}
...
\hypertarget{divididos-por-el-bienestar-segundo-libro-capuxedtulo-xiii}{%
\section{Divididos por el bienestar (Segundo libro, capítulo XIII)}\label{divididos-por-el-bienestar-segundo-libro-capuxedtulo-xiii}}
...
\hypertarget{muxe1s-que-elecciones-pegajosas-segundo-libro-capuxedtulo-xiv}{%
\section{Más que elecciones pegajosas (Segundo libro, capítulo XIV)}\label{muxe1s-que-elecciones-pegajosas-segundo-libro-capuxedtulo-xiv}}
...
\hypertarget{el-bienestar-a-solas-con-su-enemigo-segundo-libro-capuxedtulo-xv}{%
\section{El bienestar a solas con su enemigo (Segundo libro, capítulo XV)}\label{el-bienestar-a-solas-con-su-enemigo-segundo-libro-capuxedtulo-xv}}
...
\hypertarget{las-caricias-a-una-desconocida-promesa-segundo-libro-capuxedtulo-xvi}{%
\section{Las caricias a una desconocida promesa (Segundo libro, capítulo XVI)}\label{las-caricias-a-una-desconocida-promesa-segundo-libro-capuxedtulo-xvi}}
...
\hypertarget{copamiento-sospechoso-segundo-libro-capuxedtulo-xvii}{%
\section{Copamiento sospechoso (Segundo libro, capítulo XVII)}\label{copamiento-sospechoso-segundo-libro-capuxedtulo-xvii}}
...
\hypertarget{sobre-la-retardada-modernizaciuxf3n-segundo-libro-capuxedtulo-xviii}{%
\section{Sobre la retardada modernización (Segundo libro, capítulo XVIII)}\label{sobre-la-retardada-modernizaciuxf3n-segundo-libro-capuxedtulo-xviii}}
...
\hypertarget{el-regreso-a-la-lenta-cauxedda-libre-segundo-libro-capuxedtulo-xix}{%
\section{El regreso a la lenta caída libre (Segundo libro, capítulo XIX)}\label{el-regreso-a-la-lenta-cauxedda-libre-segundo-libro-capuxedtulo-xix}}
...
\hypertarget{la-disminuida-tradiciuxf3n-historiadora-segundo-libro-capuxedtulo-xx}{%
\section{La disminuida tradición historiadora (Segundo libro, capítulo XX)}\label{la-disminuida-tradiciuxf3n-historiadora-segundo-libro-capuxedtulo-xx}}
...
\hypertarget{la-finalmente-explicita-propagaciuxf3n-roja-segundo-libro-capuxedtulo-xxi}{%
\section{La finalmente explicita propagación roja (Segundo libro, capítulo XXI)}\label{la-finalmente-explicita-propagaciuxf3n-roja-segundo-libro-capuxedtulo-xxi}}
...
\hypertarget{incomunicados-entre-rozzados-segundo-libro-capuxedtulo-xxii}{%
\section{Incomunicados entre rozzados (Segundo libro, capítulo XXII)}\label{incomunicados-entre-rozzados-segundo-libro-capuxedtulo-xxii}}
...
\hypertarget{solo-conexiones-minimalistas-duxe9cimo-libro-capuxedtulo-iii}{%
...
\hypertarget{la-microruxe9plica-dada-a-luz-unduxe9cimo-libro-capuxedtulo-i}{%
\section{La microréplica dada a luz (Undécimo libro, capítulo I)}\label{la-microruxe9plica-dada-a-luz-unduxe9cimo-libro-capuxedtulo-i}}
...
Se puede realizar poco, es un casi clon plenamente básico, evidentemente ingeniado a semejanza del clásico formato de la dinámica del anonimato y etcétera, pero con varios de las piezas más fundamentales no presentes, solo letras, anaranjados y amarillos brillantes, no imágenes. La realidad es la de un territorio apenas encendido, con energía nacida en el trasfondo de su secreto desarrollo, alimentada por las escasas muestras de su aludido propósito, la interacción.

¿A qué viene todo esto? No mucho hay dicho, aunque las palabras podrían haber sido la clave. Como broma, con ironía, o para joder no más, se filtró la petición de que se haga algo como esto, una réplica en jerga del contexto, pero nadie imaginó que de verdad así iba a ser. Días más tardar, apareció como respuesta la dirección en cuestión, aún siendo muy propensa a la desconfianza, tuvo sus ingresos tal como manifestaron los bajos números públicos por allí. Y gracias a las características similares, hay lugar para el simil de los tems: los fantems. En otra parte, se copian los elementos del sitio original, la típica publicación elevada encima de las demás con el fijador morado, titulada sobre\ldots, y con una descripción paródica de la dada en los inicios de la incomprendida Titiri Nueva, el volver a empezar con lo mejor de lo ya elaborado.

Sin embargo, a diferencia de aquella, no se hace referencia a la continuación, que supuestamente esté por terminarse o no, solamente lo que es posible hacer, lo cual vale repetir, es bastante poco. Si la hubiera, quizás habría que suponer existen más coincidencias, la falta de credibilidad, aunque todavía siendo relativamente raro y sospechoso, no parece ser el caso, el dato de que viene de la misma procedencia que Linkstemti es un antecedente a favor, que invita a creer se trata del primer paso en una travesía capaz de dar más. Y si no fuera así, quedará lo que ya sucedió, un extraño precedente para la Historia Temtiana, y el haber ampliado la colección de espacios de Heroku bajo control a cinco, dos o tres contando únicamente los activos. Incluso tal vez se vayan a obtener respuestas al respecto, mientras las más importantes de antes se continúan construyendo desde la suposición.

\hypertarget{arribos-coloridamente-lisos-unduxe9cimo-libro-capuxedtulo-ii}{%
...
Ciertamente, aunque quizá no por mucho tiempo, se dio el comienzo de un extraño legado secundario en la rica y trastornada Historia Temtiana, que con su inadvertida y discreta presentación, genera particulares incógnitas en lo que pueda estar por acontecer durante las próximas horas, ni hablar días o más. Reducida evidencia hay para analizar hasta donde llega lo subjetivo: neutralidad e inexpresividad, pocas palabras, posiblemente en el fondo un leve asombro y conformidad.

Entre el despejado apartado titulado inicio, no se iniciaron muchos fantems como invita su primera posición, solamente unos pocos de tonalidad amarilla muy lejos de su posible entendimiento, anaranjada, y celeste. Escasa negatividad y poca actitud positiva, las sensaciones detectadas no dicen mucho, y sus manifestaciones, menos. Típicamente como la situación amerita en estos casos donde la experiencia es nula y el respaldo de la trayectoria relativamente inexistente, lo predecible es hacer pruebas, de las cuales ninguna resultó en alarmantes errores o impefecciones nefastas, solo que el sabor que dejaron no es tal como se llama, sin llegar a ser insípido es complicado de explicar si no es acerca lo que ya se mencionó\ldots{}

Y como era de esperarse, un mínimo de exigencia para con las limitadas prestaciones del sitio hubo. Ante ellas, desapercibidas respuestas, y por otro lado la presencia de la administración para responder las dudas más sencillas que se filtraron en la primera unidad de todos los creados, de lo que destaca aquello que se supone evidente, respecto al otro antro recóndito aún accesible, es extra oficial, y de paso se sobreentiende que su propulsor no es el mismo que dictaminó el llamado a la forzada inactividad, pero no obstante identificación, seudónimo o apodo, no ha sido revelado.
...
\hypertarget{emprendiendo-con-firmeza-unduxe9cimo-libro-capuxedtulo-iii}{%
...
\hypertarget{el-ocaso-y-amanecer-simultuxe1neo-unduxe9cimo-libro-capuxedtulo-v}{%
...
Y a su par siguiendo el correspondido sentido de la finalidad que busca, acompaña el sistema de denuncias, el cual evidentemente asistirá a la autoridad para mantener el orden que esta dice querer garantizar. También resulta curioso al recordar que para la despreciada última versión antes mencionada este nunca llegó, en comparación por mucho menos tiempo Fantemti sostiene muchas de sus carencias, pero a la vez supera en ciertas dimensiones a uno de sus ejemplos a seguir.

Para peor, o mejor, aquella no es la única en haberse esfumado en las profundidades del incógnito mantenimiento cúbico azulado, increíblemente su par de contemporánea diferente época mal renombrada se adhirió al listado de la no disponibilidad total, y repentinamente sin previo aviso dejó de ser accesible. Como consecuencia, el mayor propósito de la olvidada Linkstemti cae prácticamente obsoleto, los enlaces almacenados por su cuenta se convirtieron en vínculos inservibles, a la misma blanca y vacía escena conducen todos los pertenecientes al apartado más voluminoso.

Pese a sus obsoletas prestaciones, cada vez más opacadas por el consolidamiento de la alternativa que permitió nacer, el impactante llamado a la ausencia debe estar comunicando y representante más de lo que concretamente es, ¿el final definitivo de su existencia en pena? Poco indica que pudiera regresar, y nada lo inspira, por lo que inmediatamente se entiende que de la mano del discreto reconocimiento realizado por el canal oficial aún vivo, acaba de ceder el poco lugar que acaparaba para transferirlo a quien si recibe actividad sin restricciones, y como acostumbran sus decisiones, el incomprendido motivo quedará reservado para jamás darse a conocer, al igual que tantos otros secretos que brotaron de sus ubicaciones.

Al margen de las no menores fugacidades, por un lejano lado mucho no se alteró pues la mudanza en su mayor parte ya estaba completada, solo simbólicamente podría haber quedado un mensaje bastante significativo, el desplazado hogar de la Historia Temtiana que más episodios de todo tipo tuvo encima, quizás no retorne. Y por el otro para el conjunto implícitamente supone un gigante paso hacia adelante, porque tal es sabido faltan condiciones para al menos equipararse a lo que hasta Titiri Vieja luego de su falso cierre y antes de la actual clausura suponía, pero de a poco estas se van consiguiendo y la brecha no simbólica acortando. Por ahí cuestionarse si el ritmo mantendrá su vigor sea en vano, puesto que siendo ese el objetivo tomarse una extensa pausa no sería una buena opción, resta más por virtualizar y materializar, y la tendencia del tráfico en alza no tendría que ser frenada. Sin embargo, dentro de las concisas explicaciones nada se halla acerca de las proyecciones a futuro, ni de los planes que la administración tenga para tratar el pasar de su proyecto. La imagen general es que no hay indecisión o rumbos poco certeros, simplemente es una manera de proceder y tampoco es cuestionada, no obstante allí falta que alcancen las prolijas declaraciones oficiales.
...
\hypertarget{notas-de-ediciuxf3n-1}{%
\chapter*{Notas de edición}\label{notas-de-ediciuxf3n-1}}
\addcontentsline{toc}{chapter}{Notas de edición}

\hypertarget{novedades-en-esta-ediciuxf3n-1}{%
\section*{Novedades en esta edición}\label{novedades-en-esta-ediciuxf3n-1}}
\addcontentsline{toc}{section}{Novedades en esta edición}
...
\hypertarget{novedades-de-cada-ediciuxf3n-anterior-1}{%
\section*{Novedades de cada edición anterior}\label{novedades-de-cada-ediciuxf3n-anterior-1}}
\addcontentsline{toc}{section}{Novedades de cada edición anterior}

\hypertarget{diario-temtiano-ediciuxf3n-26.02.2022-1}{%
\subsection*{Diario Temtiano edición 26.02.2022}\label{diario-temtiano-ediciuxf3n-26.02.2022-1}}
\addcontentsline{toc}{subsection}{Diario Temtiano edición 26.02.2022}
...
\hypertarget{diario-temtiano-ediciuxf3n-24.01.2022-1}{%
\subsection*{Diario Temtiano edición 24.01.2022}\label{diario-temtiano-ediciuxf3n-24.01.2022-1}}
\addcontentsline{toc}{subsection}{Diario Temtiano edición 24.01.2022}
...
\hypertarget{diario-temtiano-ediciuxf3n-18.01.2022-1}{%
\subsection*{Diario Temtiano edición 18.01.2022}\label{diario-temtiano-ediciuxf3n-18.01.2022-1}}
\addcontentsline{toc}{subsection}{Diario Temtiano edición 18.01.2022}
...
\hypertarget{diario-temtiano-ediciuxf3n-09.01.2022-1}{%
\subsection*{Diario Temtiano edición 09.01.2022}\label{diario-temtiano-ediciuxf3n-09.01.2022-1}}
\addcontentsline{toc}{subsection}{Diario Temtiano edición 09.01.2022}
...
\hypertarget{diario-temtiano-ediciuxf3n-29.12.2021-1}{%
\subsection*{Diario Temtiano edición 29.12.2021}\label{diario-temtiano-ediciuxf3n-29.12.2021-1}}
\addcontentsline{toc}{subsection}{Diario Temtiano edición 29.12.2021}
...
\hypertarget{diario-temtiano-ediciuxf3n-17.12.2021-1}{%
\subsection*{Diario Temtiano edición 17.12.2021}\label{diario-temtiano-ediciuxf3n-17.12.2021-1}}
\addcontentsline{toc}{subsection}{Diario Temtiano edición 17.12.2021}
...
\hypertarget{diario-temtiano-ediciuxf3n-05.12.2021-1}{%
\subsection*{Diario Temtiano edición 05.12.2021}\label{diario-temtiano-ediciuxf3n-05.12.2021-1}}
\addcontentsline{toc}{subsection}{Diario Temtiano edición 05.12.2021}
...
\hypertarget{diario-temtiano-ediciuxf3n-20.11.2021-1}{%
\subsection*{Diario Temtiano edición 20.11.2021}\label{diario-temtiano-ediciuxf3n-20.11.2021-1}}
\addcontentsline{toc}{subsection}{Diario Temtiano edición 20.11.2021}
...
\hypertarget{diario-temtiano-ediciuxf3n-11.11.2021-1}{%
\subsection*{Diario Temtiano edición 11.11.2021}\label{diario-temtiano-ediciuxf3n-11.11.2021-1}}
\addcontentsline{toc}{subsection}{Diario Temtiano edición 11.11.2021}
...
\hypertarget{diario-temtiano-ediciuxf3n-01.11.2021-1}{%
\subsection*{Diario Temtiano edición 01.11.2021}\label{diario-temtiano-ediciuxf3n-01.11.2021-1}}
\addcontentsline{toc}{subsection}{Diario Temtiano edición 01.11.2021}
...
\hypertarget{diario-temtiano-ediciuxf3n-20.10.2021-1}{%
\subsection*{Diario Temtiano edición 20.10.2021}\label{diario-temtiano-ediciuxf3n-20.10.2021-1}}
\addcontentsline{toc}{subsection}{Diario Temtiano edición 20.10.2021}
...
\hypertarget{diario-temtiano-ediciuxf3n-12.10.2021-1}{%
\subsection*{Diario Temtiano edición 12.10.2021}\label{diario-temtiano-ediciuxf3n-12.10.2021-1}}
\addcontentsline{toc}{subsection}{Diario Temtiano edición 12.10.2021}
...
\hypertarget{diario-temtiano-ediciuxf3n-01.10.2021-1}{%
\subsection*{Diario Temtiano edición 01.10.2021}\label{diario-temtiano-ediciuxf3n-01.10.2021-1}}
\addcontentsline{toc}{subsection}{Diario Temtiano edición 01.10.2021}
...
\hypertarget{diario-temtiano-ediciuxf3n-20.09.2021-1}{%
\subsection*{Diario Temtiano edición 20.09.2021}\label{diario-temtiano-ediciuxf3n-20.09.2021-1}}
\addcontentsline{toc}{subsection}{Diario Temtiano edición 20.09.2021}
...
\hypertarget{diario-temtiano-ediciuxf3n-15.09.2021-1}{%
\subsection*{Diario Temtiano edición 15.09.2021}\label{diario-temtiano-ediciuxf3n-15.09.2021-1}}
\addcontentsline{toc}{subsection}{Diario Temtiano edición 15.09.2021}
...
\hypertarget{diario-temtiano-ediciuxf3n-09.09.2021-1}{%
\subsection*{Diario Temtiano edición 09.09.2021}\label{diario-temtiano-ediciuxf3n-09.09.2021-1}}
\addcontentsline{toc}{subsection}{Diario Temtiano edición 09.09.2021}
...
\hypertarget{diario-temtiano-ediciuxf3n-04.09.2021-1}{%
\subsection*{Diario Temtiano edición 04.09.2021}\label{diario-temtiano-ediciuxf3n-04.09.2021-1}}
\addcontentsline{toc}{subsection}{Diario Temtiano edición 04.09.2021}
...
\hypertarget{diario-temtiano-ediciuxf3n-01.09.2021-1}{%
\subsection*{Diario Temtiano edición 01.09.2021}\label{diario-temtiano-ediciuxf3n-01.09.2021-1}}
\addcontentsline{toc}{subsection}{Diario Temtiano edición 01.09.2021}
...
\hypertarget{diario-temtiano-ediciuxf3n-01.06.2021-1}{%
\subsection*{Diario Temtiano edición 01.06.2021}\label{diario-temtiano-ediciuxf3n-01.06.2021-1}}
\addcontentsline{toc}{subsection}{Diario Temtiano edición 01.06.2021}
...
\hypertarget{diario-temtiano-ediciuxf3n-27.05.2021-1}{%
\subsection*{Diario Temtiano edición 27.05.2021}\label{diario-temtiano-ediciuxf3n-27.05.2021-1}}
\addcontentsline{toc}{subsection}{Diario Temtiano edición 27.05.2021}
...
\hypertarget{diario-temtiano-ediciuxf3n-22.05.2021-1}{%
\subsection*{Diario Temtiano edición 22.05.2021}\label{diario-temtiano-ediciuxf3n-22.05.2021-1}}
\addcontentsline{toc}{subsection}{Diario Temtiano edición 22.05.2021}
...
\hypertarget{diario-temtiano-ediciuxf3n-12.05.2021-1}{%
\subsection*{Diario Temtiano edición 12.05.2021}\label{diario-temtiano-ediciuxf3n-12.05.2021-1}}
\addcontentsline{toc}{subsection}{Diario Temtiano edición 12.05.2021}
...
\hypertarget{diario-temtiano-ediciuxf3n-07.05.2021-1}{%
\subsection*{Diario Temtiano edición 07.05.2021}\label{diario-temtiano-ediciuxf3n-07.05.2021-1}}
\addcontentsline{toc}{subsection}{Diario Temtiano edición 07.05.2021}
...
\hypertarget{diario-temtiano-ediciuxf3n-04.05.2021-1}{%
\subsection*{Diario Temtiano edición 04.05.2021}\label{diario-temtiano-ediciuxf3n-04.05.2021-1}}
\addcontentsline{toc}{subsection}{Diario Temtiano edición 04.05.2021}
...
\hypertarget{diario-temtiano-ediciuxf3n-27.04.2021-1}{%
\subsection*{Diario Temtiano edición 27.04.2021}\label{diario-temtiano-ediciuxf3n-27.04.2021-1}}
\addcontentsline{toc}{subsection}{Diario Temtiano edición 27.04.2021}
...
\hypertarget{diario-temtiano-ediciuxf3n-11.04.2021-1}{%
\subsection*{Diario Temtiano edición 11.04.2021}\label{diario-temtiano-ediciuxf3n-11.04.2021-1}}
\addcontentsline{toc}{subsection}{Diario Temtiano edición 11.04.2021}
...
\hypertarget{diario-temtiano-ediciuxf3n-30.03.2021-1}{%
\subsection*{Diario Temtiano edición 30.03.2021}\label{diario-temtiano-ediciuxf3n-30.03.2021-1}}
\addcontentsline{toc}{subsection}{Diario Temtiano edición 30.03.2021}
...
\hypertarget{diario-temtiano-ediciuxf3n-28.03.2021-1}{%
\subsection*{Diario Temtiano edición 28.03.2021}\label{diario-temtiano-ediciuxf3n-28.03.2021-1}}
\addcontentsline{toc}{subsection}{Diario Temtiano edición 28.03.2021}
...
\hypertarget{diario-temtiano-ediciuxf3n-23.03.2021-1}{%
\subsection*{Diario Temtiano edición 23.03.2021}\label{diario-temtiano-ediciuxf3n-23.03.2021-1}}
\addcontentsline{toc}{subsection}{Diario Temtiano edición 23.03.2021}
...
\hypertarget{diario-temtiano-ediciuxf3n-08.03.2021-1}{%
\subsection*{Diario Temtiano edición 08.03.2021}\label{diario-temtiano-ediciuxf3n-08.03.2021-1}}
\addcontentsline{toc}{subsection}{Diario Temtiano edición 08.03.2021}
...
\hypertarget{diario-temtiano-ediciuxf3n-01.03.2021-1}{%
\subsection*{Diario Temtiano edición 01.03.2021}\label{diario-temtiano-ediciuxf3n-01.03.2021-1}}
\addcontentsline{toc}{subsection}{Diario Temtiano edición 01.03.2021}
...
\hypertarget{diario-temtiano-ediciuxf3n-26.02.2021-1}{%
\subsection*{Diario Temtiano edición 26.02.2021}\label{diario-temtiano-ediciuxf3n-26.02.2021-1}}
\addcontentsline{toc}{subsection}{Diario Temtiano edición 26.02.2021}
...
\hypertarget{sin-titular-25.02.2021-1}{%
\subsection*{(sin titular) 25.02.2021}\label{sin-titular-25.02.2021-1}}
\addcontentsline{toc}{subsection}{(sin titular) 25.02.2021}
...
\hypertarget{sin-titular-19.02.2021-1}{%
\subsection*{(sin titular) 19.02.2021}\label{sin-titular-19.02.2021-1}}
\addcontentsline{toc}{subsection}{(sin titular) 19.02.2021}
...
\hypertarget{sin-titular-18.02.2021-1}{%
\subsection*{(sin titular) 18.02.2021}\label{sin-titular-18.02.2021-1}}
\addcontentsline{toc}{subsection}{(sin titular) 18.02.2021}
...
\hypertarget{sin-titular-15.02.2021-1}{%
\subsection*{(sin titular) 15.02.2021}\label{sin-titular-15.02.2021-1}}
\addcontentsline{toc}{subsection}{(sin titular) 15.02.2021}
...
\hypertarget{sin-titular-13.02.2021-1}{%
\subsection*{(sin titular) 13.02.2021}\label{sin-titular-13.02.2021-1}}
\addcontentsline{toc}{subsection}{(sin titular) 13.02.2021}
...
\hypertarget{sin-titular-11.02.2021-1}{%
\subsection*{(sin titular) 11.02.2021}\label{sin-titular-11.02.2021-1}}
\addcontentsline{toc}{subsection}{(sin titular) 11.02.2021}
...
\hypertarget{sin-titular-10.02.2021-1}{%
\subsection*{(sin titular) 10.02.2021}\label{sin-titular-10.02.2021-1}}
\addcontentsline{toc}{subsection}{(sin titular) 10.02.2021}
...
\hypertarget{sin-titular-09.02.2021-1}{%
\subsection*{(sin titular) 09.02.2021}\label{sin-titular-09.02.2021-1}}
\addcontentsline{toc}{subsection}{(sin titular) 09.02.2021}
...
\hypertarget{sin-titular-08.02.2021-1}{%
\subsection*{(sin titular) 08.02.2021}\label{sin-titular-08.02.2021-1}}
\addcontentsline{toc}{subsection}{(sin titular) 08.02.2021}
...
\hypertarget{sin-titular-04.02.2021-1}{%
\subsection*{(sin titular) 04.02.2021}\label{sin-titular-04.02.2021-1}}
\addcontentsline{toc}{subsection}{(sin titular) 04.02.2021}
...
\hypertarget{muxe1s-sobre-diario-temtiano-1}{%
\chapter*{Más sobre Diario Temtiano}\label{muxe1s-sobre-diario-temtiano-1}}
\addcontentsline{toc}{chapter}{Más sobre Diario Temtiano}
...
\hypertarget{actualizaciones-1}{%
\section*{Actualizaciones}\label{actualizaciones-1}}
\addcontentsline{toc}{section}{Actualizaciones}
...
\hypertarget{el-porquuxe9-1}{%
\section*{El porqué}\label{el-porquuxe9-1}}
\addcontentsline{toc}{section}{El porqué}
...
\hypertarget{el-primer-gran-puente-de-la-literatura-temtiana-prefacio-1}{%
\chapter{El primer gran puente de la literatura temtiana (Prefacio)}\label{el-primer-gran-puente-de-la-literatura-temtiana-prefacio-1}}
...
\hypertarget{la-nueva-cuna-de-la-explicaciuxf3n-introducciuxf3n-1}{%
\chapter{La nueva cuna de la explicación (Introducción)}\label{la-nueva-cuna-de-la-explicaciuxf3n-introducciuxf3n-1}}

Los diferentes quiebres que marcaron claramente el comienzo de una nueva etapa son el motivo más evidente, aunque quizá no el principal para que se haya formado un apartado más entre todas las riquezas culturales de Temti. Siendo una pieza que por sí sola no es suficiente para entender correctamente todo su contenido, y que también es derivada de los dos primeros libros de Crónicas Temtianas, acompañará para siempre el vasto conjunto de elementos que forman la historia y la identidad temtiana.

En esta serie cronológica de textos muy conexos a los viajes entre dimensiones y tiempo, bajo las ordenes de ciertos principios y deberes morales, los acontecimientos más relevantes vuelven a ser revividos e interpretados, intentando atrapar cada detalle que pueda escaparse, en ocasiones abrazando cierta perspectiva desligada de neutralidad, y en otras acercándose a la objetividad, pero nunca desviándose de las dos palabras disparadoras que tanto pero tanto significan: Sobre Temti. Eso es Diario Temtiano.

\hypertarget{las-secuelas-de-una-supuesta-muerte-no-anunciada-primer-libro-1}{%
\chapter{Las secuelas de una supuesta muerte no anunciada (Primer libro)}\label{las-secuelas-de-una-supuesta-muerte-no-anunciada-primer-libro-1}}
...
\hypertarget{en-el-contexto-de-la-fruxe1gil-certidumbre-primer-libro-capuxedtulo-i-1}{%
\section{En el contexto de la frágil certidumbre (Primer libro, capítulo I)}\label{en-el-contexto-de-la-fruxe1gil-certidumbre-primer-libro-capuxedtulo-i-1}}
...
\hypertarget{un-autuxe9ntico-renacer-primer-libro-capuxedtulo-ii-1}{%
\section{Un auténtico renacer (Primer libro, capítulo II)}\label{un-autuxe9ntico-renacer-primer-libro-capuxedtulo-ii-1}}
...
\hypertarget{concretando-la-evacuaciuxf3n-primer-libro-capuxedtulo-iii-1}{%
\section{Concretando la evacuación (Primer libro, capítulo III)}\label{concretando-la-evacuaciuxf3n-primer-libro-capuxedtulo-iii-1}}
...
\hypertarget{el-inviable-paso-hacuxeda-la-iluminaciuxf3n-primer-libro-capuxedtulo-iv-1}{%
\section{El inviable paso hacía la iluminación (Primer libro, capítulo IV)}\label{el-inviable-paso-hacuxeda-la-iluminaciuxf3n-primer-libro-capuxedtulo-iv-1}}
...
\hypertarget{fuegos-salvajes-en-las-aguas-primer-libro-capuxedtulo-v-1}{%
\section{Fuegos salvajes en las aguas (Primer libro, capítulo V)}\label{fuegos-salvajes-en-las-aguas-primer-libro-capuxedtulo-v-1}}
...
\hypertarget{en-encrucijada-de-diuxe1sporas-primer-libro-capuxedtulo-vi-1}{%
\section{En encrucijada de diásporas (Primer libro, capítulo VI)}\label{en-encrucijada-de-diuxe1sporas-primer-libro-capuxedtulo-vi-1}}
...
\hypertarget{la-masificada-intriga-intencionada-primer-libro-capuxedtulo-vii-1}{%
\section{La masificada intriga intencionada (Primer libro, capítulo VII)}\label{la-masificada-intriga-intencionada-primer-libro-capuxedtulo-vii-1}}
...
\hypertarget{el-alcance-de-un-experimentado-y-recargado-comienzo-prometedor-segundo-libro-1}{%
\chapter{El alcance de un experimentado y recargado comienzo prometedor (Segundo libro)}\label{el-alcance-de-un-experimentado-y-recargado-comienzo-prometedor-segundo-libro-1}}
...
\hypertarget{la-faceta-dual-de-la-esperanza-segundo-libro-capuxedtulo-i-1}{%
\section{La faceta dual de la esperanza (Segundo libro, capítulo I)}\label{la-faceta-dual-de-la-esperanza-segundo-libro-capuxedtulo-i-1}}
...
\hypertarget{el-reencuentro-del-potencial-vacuxedo-segundo-libro-capuxedtulo-ii-1}{%
\section{El reencuentro del potencial vacío (Segundo libro, capítulo II)}\label{el-reencuentro-del-potencial-vacuxedo-segundo-libro-capuxedtulo-ii-1}}
...
\hypertarget{en-doble-contra-del-abandono-segundo-libro-capuxedtulo-iii-1}{%
\section{En doble contra del abandono (Segundo libro, capítulo III)}\label{en-doble-contra-del-abandono-segundo-libro-capuxedtulo-iii-1}}
...
\hypertarget{mientras-se-buscan-respuestas-que-nadie-daruxe1-segundo-libro-capuxedtulo-iv-1}{%
\section{Mientras se buscan respuestas que nadie dará (Segundo libro, capítulo IV)}\label{mientras-se-buscan-respuestas-que-nadie-daruxe1-segundo-libro-capuxedtulo-iv-1}}
...
\hypertarget{la-anexiuxf3n-de-la-paz-y-del-progreso-segundo-libro-capuxedtulo-v-1}{%
\section{La anexión de la paz y del ¿progreso? (Segundo libro, capítulo V)}\label{la-anexiuxf3n-de-la-paz-y-del-progreso-segundo-libro-capuxedtulo-v-1}}
...
\hypertarget{las-anomaluxedas-bajo-blindaje-segundo-libro-capuxedtulo-vi-1}{%
\section{Las anomalías bajo blindaje (Segundo libro, capítulo VI)}\label{las-anomaluxedas-bajo-blindaje-segundo-libro-capuxedtulo-vi-1}}
...
\hypertarget{la-renovaciuxf3n-de-lo-exclusivo-segundo-libro-capuxedtulo-vii-1}{%
\section{La renovación de lo exclusivo (Segundo libro, capítulo VII)}\label{la-renovaciuxf3n-de-lo-exclusivo-segundo-libro-capuxedtulo-vii-1}}
...
\hypertarget{redescubierto-lo-multiversal-segundo-libro-capuxedtulo-viii-1}{%
\section{Redescubierto lo multiversal (Segundo libro, capítulo VIII)}\label{redescubierto-lo-multiversal-segundo-libro-capuxedtulo-viii-1}}
...
\hypertarget{temti-entre-los-grandes-o-debajo-de-ellos-segundo-libro-capuxedtulo-ix-1}{%
\section{Temti entre los grandes, o debajo de ellos (Segundo libro, capítulo IX)}\label{temti-entre-los-grandes-o-debajo-de-ellos-segundo-libro-capuxedtulo-ix-1}}
...
\hypertarget{el-derrocamiento-anuxf3nimo-segundo-libro-capuxedtulo-x-1}{%
\section{El derrocamiento anónimo (Segundo libro, capítulo X)}\label{el-derrocamiento-anuxf3nimo-segundo-libro-capuxedtulo-x-1}}
...
\hypertarget{el-retorno-de-las-invasiones-escandalosas-segundo-libro-capuxedtulo-xi-1}{%
\section{El retorno de las invasiones escandalosas (Segundo libro, capítulo XI)}\label{el-retorno-de-las-invasiones-escandalosas-segundo-libro-capuxedtulo-xi-1}}
...
\hypertarget{la-grieta-de-la-profunda-crisis-de-resistencia-segundo-libro-capuxedtulo-xii-1}{%
\section{La grieta de la profunda crisis de resistencia (Segundo libro, capítulo XII)}\label{la-grieta-de-la-profunda-crisis-de-resistencia-segundo-libro-capuxedtulo-xii-1}}
...
\hypertarget{divididos-por-el-bienestar-segundo-libro-capuxedtulo-xiii-1}{%
\section{Divididos por el bienestar (Segundo libro, capítulo XIII)}\label{divididos-por-el-bienestar-segundo-libro-capuxedtulo-xiii-1}}
...
\hypertarget{muxe1s-que-elecciones-pegajosas-segundo-libro-capuxedtulo-xiv-1}{%
\section{Más que elecciones pegajosas (Segundo libro, capítulo XIV)}\label{muxe1s-que-elecciones-pegajosas-segundo-libro-capuxedtulo-xiv-1}}
...
\hypertarget{el-bienestar-a-solas-con-su-enemigo-segundo-libro-capuxedtulo-xv-1}{%
\section{El bienestar a solas con su enemigo (Segundo libro, capítulo XV)}\label{el-bienestar-a-solas-con-su-enemigo-segundo-libro-capuxedtulo-xv-1}}
...
\hypertarget{las-caricias-a-una-desconocida-promesa-segundo-libro-capuxedtulo-xvi-1}{%
\section{Las caricias a una desconocida promesa (Segundo libro, capítulo XVI)}\label{las-caricias-a-una-desconocida-promesa-segundo-libro-capuxedtulo-xvi-1}}
...
\hypertarget{copamiento-sospechoso-segundo-libro-capuxedtulo-xvii-1}{%
\section{Copamiento sospechoso (Segundo libro, capítulo XVII)}\label{copamiento-sospechoso-segundo-libro-capuxedtulo-xvii-1}}
...
\hypertarget{sobre-la-retardada-modernizaciuxf3n-segundo-libro-capuxedtulo-xviii-1}{%
\section{Sobre la retardada modernización (Segundo libro, capítulo XVIII)}\label{sobre-la-retardada-modernizaciuxf3n-segundo-libro-capuxedtulo-xviii-1}}
...
\hypertarget{el-regreso-a-la-lenta-cauxedda-libre-segundo-libro-capuxedtulo-xix-1}{%
\section{El regreso a la lenta caída libre (Segundo libro, capítulo XIX)}\label{el-regreso-a-la-lenta-cauxedda-libre-segundo-libro-capuxedtulo-xix-1}}
...
\hypertarget{la-disminuida-tradiciuxf3n-historiadora-segundo-libro-capuxedtulo-xx-1}{%
\section{La disminuida tradición historiadora (Segundo libro, capítulo XX)}\label{la-disminuida-tradiciuxf3n-historiadora-segundo-libro-capuxedtulo-xx-1}}
...
\hypertarget{la-finalmente-explicita-propagaciuxf3n-roja-segundo-libro-capuxedtulo-xxi-1}{%
\section{La finalmente explicita propagación roja (Segundo libro, capítulo XXI)}\label{la-finalmente-explicita-propagaciuxf3n-roja-segundo-libro-capuxedtulo-xxi-1}}
...
\hypertarget{incomunicados-entre-rozzados-segundo-libro-capuxedtulo-xxii-1}{%
\section{Incomunicados entre rozzados (Segundo libro, capítulo XXII)}\label{incomunicados-entre-rozzados-segundo-libro-capuxedtulo-xxii-1}}
...
\hypertarget{cuando-tal-vez-se-vea-quuxe9-realmente-queda-para-siempre-tercer-libro-1}{%
\chapter{Cuando tal vez se vea qué realmente queda para siempre (Tercer libro)}\label{cuando-tal-vez-se-vea-quuxe9-realmente-queda-para-siempre-tercer-libro-1}}
...
\hypertarget{el-comienzo-de-una-nueva-prueba-de-fuego-tercer-libro-capuxedtulo-i-1}{%
\section{El comienzo de una nueva prueba de fuego (Tercer libro, capítulo I)}\label{el-comienzo-de-una-nueva-prueba-de-fuego-tercer-libro-capuxedtulo-i-1}}
...
\hypertarget{prestigio-no-tan-valioso-tercer-libro-capuxedtulo-ii-1}{%
\section{Prestigio no tan valioso (Tercer libro, capítulo II)}\label{prestigio-no-tan-valioso-tercer-libro-capuxedtulo-ii-1}}
...
\hypertarget{la-protecciuxf3n-en-un-lugar-inseguro-tercer-libro-capuxedtulo-iii-1}{%
\section{La protección en un lugar inseguro (Tercer libro, capítulo III)}\label{la-protecciuxf3n-en-un-lugar-inseguro-tercer-libro-capuxedtulo-iii-1}}
...
\hypertarget{a-falta-de-oro-verdadero-tercer-libro-capuxedtulo-iv-1}{%
\section{A falta de oro verdadero (Tercer libro, capítulo IV)}\label{a-falta-de-oro-verdadero-tercer-libro-capuxedtulo-iv-1}}
...
\hypertarget{cielo-incongruente-tercer-libro-capuxedtulo-v-1}{%
\section{Cielo incongruente (Tercer libro, capítulo V)}\label{cielo-incongruente-tercer-libro-capuxedtulo-v-1}}
...
\hypertarget{destellos-reiterados-en-la-oscuridad-tercer-libro-capuxedtulo-vi-1}{%
\section{Destellos reiterados en la oscuridad (Tercer libro, capítulo VI)}\label{destellos-reiterados-en-la-oscuridad-tercer-libro-capuxedtulo-vi-1}}
...
\hypertarget{los-primeros-fracasos-enigmuxe1ticos-tercer-libro-capuxedtulo-vii-1}{%
\section{Los primeros fracasos enigmáticos (Tercer libro, capítulo VII)}\label{los-primeros-fracasos-enigmuxe1ticos-tercer-libro-capuxedtulo-vii-1}}
...
\hypertarget{la-luna-ignuxedfuga-tercer-libro-capuxedtulo-viii-1}{%
\section{La luna ignífuga (Tercer libro, capítulo VIII)}\label{la-luna-ignuxedfuga-tercer-libro-capuxedtulo-viii-1}}
...
\hypertarget{la-intensificaciuxf3n-del-fruxedo-silencio-tercer-libro-capuxedtulo-ix-1}{%
\section{La intensificación del frío silencio (Tercer libro, capítulo IX)}\label{la-intensificaciuxf3n-del-fruxedo-silencio-tercer-libro-capuxedtulo-ix-1}}
...
\hypertarget{los-recortes-muxe1s-evidentes-tercer-libro-capuxedtulo-x-1}{%
\section{Los recortes más evidentes (Tercer libro, capítulo X)}\label{los-recortes-muxe1s-evidentes-tercer-libro-capuxedtulo-x-1}}
...
\hypertarget{las-esqueluxe9ticas-sobras-del-auxf1orado-pasado-tercer-libro-capuxedtulo-xi-1}{%
\section{Las esqueléticas sobras del añorado pasado (Tercer libro, capítulo XI)}\label{las-esqueluxe9ticas-sobras-del-auxf1orado-pasado-tercer-libro-capuxedtulo-xi-1}}
...
\hypertarget{la-incultura-al-desnudo-tercer-libro-capuxedtulo-xii-1}{%
\section{La incultura al desnudo (Tercer libro, capítulo XII)}\label{la-incultura-al-desnudo-tercer-libro-capuxedtulo-xii-1}}
...
\hypertarget{la-nueva-temti-y-otra-de-sus-enormes-proyecciones-tercer-libro-capuxedtulo-xiii-1}{%
\section{La nueva Temti, y otra de sus enormes proyecciones (Tercer libro, capítulo XIII)}\label{la-nueva-temti-y-otra-de-sus-enormes-proyecciones-tercer-libro-capuxedtulo-xiii-1}}
...
\hypertarget{el-olvidado-vinculo-infernal-tercer-libro-capuxedtulo-xiv-1}{%
\section{El olvidado vinculo infernal (Tercer libro, capítulo XIV)}\label{el-olvidado-vinculo-infernal-tercer-libro-capuxedtulo-xiv-1}}
...
\hypertarget{algo-se-reprodujo-tercer-libro-capuxedtulo-xv-1}{%
\section{\ldots Algo se reprodujo (Tercer libro, capítulo XV)}\label{algo-se-reprodujo-tercer-libro-capuxedtulo-xv-1}}
...
\hypertarget{una-noche-de-lucha-a-la-amargura-tercer-libro-capuxedtulo-xvi-1}{%
\section{Una noche de lucha a la amargura (Tercer libro, capítulo XVI)}\label{una-noche-de-lucha-a-la-amargura-tercer-libro-capuxedtulo-xvi-1}}
...
\hypertarget{la-base-de-una-pequeuxf1a-distopia-tercer-libro-capuxedtulo-xvii-1}{%
\section{La base de una pequeña distopia (Tercer libro, capítulo XVII)}\label{la-base-de-una-pequeuxf1a-distopia-tercer-libro-capuxedtulo-xvii-1}}
...
\hypertarget{informes-de-dudosa-procedencia-tercer-libro-capuxedtulo-xviii-1}{%
\section{Informes de dudosa procedencia (Tercer libro, capítulo XVIII)}\label{informes-de-dudosa-procedencia-tercer-libro-capuxedtulo-xviii-1}}
...
\hypertarget{inestabilidad-silenciosa-tercer-libro-capuxedtulo-xix-1}{%
\section{Inestabilidad silenciosa (Tercer libro, capítulo XIX)}\label{inestabilidad-silenciosa-tercer-libro-capuxedtulo-xix-1}}
...
\hypertarget{el-durante-cuando-los-duxedas-estuxe1n-muxe1s-que-contados-cuarto-libro-1}{%
\chapter{El durante cuando los días están más que contados (Cuarto libro)}\label{el-durante-cuando-los-duxedas-estuxe1n-muxe1s-que-contados-cuarto-libro-1}}
...
\hypertarget{una-muxe1s-del-antro-de-las-esperas-eternas-cuarto-libro-capuxedtulo-i-1}{%
\section{Una más del antro de las esperas eternas (Cuarto libro, capítulo I)}\label{una-muxe1s-del-antro-de-las-esperas-eternas-cuarto-libro-capuxedtulo-i-1}}
...
\hypertarget{el-discreto-alegre-contraste-del-deterioro-cuarto-libro-capuxedtulo-ii-1}{%
\section{El discreto alegre contraste del deterioro (Cuarto libro, capítulo II)}\label{el-discreto-alegre-contraste-del-deterioro-cuarto-libro-capuxedtulo-ii-1}}
...
\hypertarget{otra-vez-de-paseo-a-la-deriva-cuarto-libro-capuxedtulo-iii-1}{%
\section{Otra vez de paseo a la deriva (Cuarto libro, capítulo III)}\label{otra-vez-de-paseo-a-la-deriva-cuarto-libro-capuxedtulo-iii-1}}
...
\hypertarget{mientras-se-estuxe1-a-la-deriva-entre-la-vida-y-la-incertidumbre-quinto-libro-1}{%
\chapter{Mientras se está a la deriva entre la vida y la incertidumbre (Quinto libro)}\label{mientras-se-estuxe1-a-la-deriva-entre-la-vida-y-la-incertidumbre-quinto-libro-1}}
...
\hypertarget{el-hospedaje-impostergable-cuarto-libro-capuxedtulo-i-1}{%
\section{El hospedaje impostergable (Cuarto libro, capítulo I)}\label{el-hospedaje-impostergable-cuarto-libro-capuxedtulo-i-1}}
...
\hypertarget{como-en-casa-quinto-libro-capuxedtulo-ii-1}{%
\section{¿Como en casa? (Quinto libro, capítulo II)}\label{como-en-casa-quinto-libro-capuxedtulo-ii-1}}
...
\hypertarget{los-estudios-sobre-una-burda-copia-quinto-libro-capuxedtulo-iii-1}{%
\section{Los estudios sobre una burda copia (Quinto libro, capítulo III)}\label{los-estudios-sobre-una-burda-copia-quinto-libro-capuxedtulo-iii-1}}
...
\hypertarget{pobre-y-fuerte-razuxf3n-de-ser-quinto-libro-capuxedtulo-iv-1}{%
\section{Pobre y fuerte razón de ser (Quinto libro, capítulo IV)}\label{pobre-y-fuerte-razuxf3n-de-ser-quinto-libro-capuxedtulo-iv-1}}
...
\hypertarget{coparticipativos-desequilibrios-territoriales-quinto-libro-capuxedtulo-v-1}{%
\section{Coparticipativos desequilibrios territoriales (Quinto libro, capítulo V)}\label{coparticipativos-desequilibrios-territoriales-quinto-libro-capuxedtulo-v-1}}
...
\hypertarget{agridulce-expansiuxf3n-de-la-fama-quinto-libro-capuxedtulo-vi-1}{%
\section{Agridulce expansión de la fama (Quinto libro, capítulo VI)}\label{agridulce-expansiuxf3n-de-la-fama-quinto-libro-capuxedtulo-vi-1}}
...
\hypertarget{reivindicando-la-pulseada-de-la-verdad-quinto-libro-capuxedtulo-vii-1}{%
\section{Reivindicando la pulseada de la verdad (Quinto libro, capítulo VII)}\label{reivindicando-la-pulseada-de-la-verdad-quinto-libro-capuxedtulo-vii-1}}
...
\hypertarget{la-cauxedda-en-la-lucha-trascendental-quinto-libro-capuxedtulo-viii-1}{%
\section{La caída en la lucha trascendental (Quinto libro, capítulo VIII)}\label{la-cauxedda-en-la-lucha-trascendental-quinto-libro-capuxedtulo-viii-1}}
...
\hypertarget{el-fin-impluxedcito-quinto-libro-capuxedtulo-ix-1}{%
\section{El fin implícito (Quinto libro, capítulo IX)}\label{el-fin-impluxedcito-quinto-libro-capuxedtulo-ix-1}}
...
\hypertarget{un-paso-muxe1s-cerca-para-descubrir-lo-distante-que-se-estuxe1-quinto-libro-capuxedtulo-x-1}{%
\section{Un paso más cerca para descubrir lo distante que se está (Quinto libro, capítulo X)}\label{un-paso-muxe1s-cerca-para-descubrir-lo-distante-que-se-estuxe1-quinto-libro-capuxedtulo-x-1}}
...
\hypertarget{sensaciones-de-descanso-eterno-quinto-libro-capuxedtulo-xi-1}{%
\section{Sensaciones de descanso eterno (Quinto libro, capítulo XI)}\label{sensaciones-de-descanso-eterno-quinto-libro-capuxedtulo-xi-1}}
...
\hypertarget{buscando-esa-dulce-compauxf1uxeda-quinto-libro-capuxedtulo-xii-1}{%
\section{Buscando esa dulce compañía (Quinto libro, capítulo XII)}\label{buscando-esa-dulce-compauxf1uxeda-quinto-libro-capuxedtulo-xii-1}}
...
\hypertarget{en-atmuxf3sfera-del-mismo-advenimiento-quinto-libro-capuxedtulo-xiii-1}{%
\section{En atmósfera del mismo advenimiento (Quinto libro, capítulo XIII)}\label{en-atmuxf3sfera-del-mismo-advenimiento-quinto-libro-capuxedtulo-xiii-1}}
...
\hypertarget{la-uxe9poca-de-las-infinitas-pruxf3rrogas-disfuncionales-sexto-libro-1}{%
\chapter{La época de las infinitas prórrogas disfuncionales (Sexto libro)}\label{la-uxe9poca-de-las-infinitas-pruxf3rrogas-disfuncionales-sexto-libro-1}}
...
\hypertarget{el-histuxf3rico-fracaso-de-los-seres-terrenales-sexto-libro-capuxedtulo-i-1}{%
\section{El histórico fracaso de los seres terrenales (Sexto libro, capítulo I)}\label{el-histuxf3rico-fracaso-de-los-seres-terrenales-sexto-libro-capuxedtulo-i-1}}
...
\hypertarget{ruxe9cord-de-desoriente-sexto-libro-capuxedtulo-ii-1}{%
\section{Récord de desoriente (Sexto libro, capítulo II)}\label{ruxe9cord-de-desoriente-sexto-libro-capuxedtulo-ii-1}}
...
\hypertarget{la-calma-de-la-fruxeda-lejanuxeda-sexto-libro-capuxedtulo-iii-1}{%
\section{La calma de la fría lejanía (Sexto libro, capítulo III)}\label{la-calma-de-la-fruxeda-lejanuxeda-sexto-libro-capuxedtulo-iii-1}}
...
\hypertarget{en-vuxedsperas-de-aterrizaje-sexto-libro-capuxedtulo-iv-1}{%
\section{En vísperas de aterrizaje (Sexto libro, capítulo IV)}\label{en-vuxedsperas-de-aterrizaje-sexto-libro-capuxedtulo-iv-1}}
...
\hypertarget{colisiuxf3n-de-ilusiones-sexto-libro-capuxedtulo-v-1}{%
\section{Colisión de ilusiones (Sexto libro, capítulo V)}\label{colisiuxf3n-de-ilusiones-sexto-libro-capuxedtulo-v-1}}
...
\hypertarget{sobre-el-insondable-luxedmite-sexto-libro-capuxedtulo-vi-1}{%
\section{Sobre el insondable límite (Sexto libro, capítulo VI)}\label{sobre-el-insondable-luxedmite-sexto-libro-capuxedtulo-vi-1}}
...
\hypertarget{en-continuidad-con-el-desvanecimiento-sexto-libro-capuxedtulo-vii-1}{%
\section{En continuidad con el desvanecimiento (Sexto libro, capítulo VII)}\label{en-continuidad-con-el-desvanecimiento-sexto-libro-capuxedtulo-vii-1}}
...
\hypertarget{el-pausado-desarrollo-a-pleno-sexto-libro-capuxedtulo-viii-1}{%
\section{El pausado desarrollo a pleno (Sexto libro, capítulo VIII)}\label{el-pausado-desarrollo-a-pleno-sexto-libro-capuxedtulo-viii-1}}
...
\hypertarget{la-tierra-de-mensajes-intermitentes-sexto-libro-capuxedtulo-ix-1}{%
\section{La tierra de mensajes intermitentes (Sexto libro, capítulo IX)}\label{la-tierra-de-mensajes-intermitentes-sexto-libro-capuxedtulo-ix-1}}
...
\hypertarget{las-inhibidas-andanzas-bajo-la-apta-nueva-normalidad-suxe9ptimo-libro-1}{%
\chapter{Las inhibidas andanzas bajo la apta nueva normalidad (Séptimo libro)}\label{las-inhibidas-andanzas-bajo-la-apta-nueva-normalidad-suxe9ptimo-libro-1}}
...
\hypertarget{la-parcial-pero-suficiente-reanudaciuxf3n-suxe9ptimo-libro-capuxedtulo-i-1}{%
\section{La parcial pero suficiente reanudación (Séptimo libro, capítulo I)}\label{la-parcial-pero-suficiente-reanudaciuxf3n-suxe9ptimo-libro-capuxedtulo-i-1}}
...
\hypertarget{el-tambaleante-festival-de-cepillos-suxe9ptimo-libro-capuxedtulo-ii-1}{%
\section{El tambaleante festival de cepillos (Séptimo libro, capítulo II)}\label{el-tambaleante-festival-de-cepillos-suxe9ptimo-libro-capuxedtulo-ii-1}}
...
\hypertarget{avances-a-la-usanza-suxe9ptimo-libro-capuxedtulo-iii-1}{%
\section{Avances a la usanza (Séptimo libro, capítulo III)}\label{avances-a-la-usanza-suxe9ptimo-libro-capuxedtulo-iii-1}}
...
\hypertarget{los-recovecos-donde-el-humo-amarillento-suxe9ptimo-libro-capuxedtulo-iv-1}{%
\section{Los recovecos donde el humo amarillento (Séptimo libro, capítulo IV)}\label{los-recovecos-donde-el-humo-amarillento-suxe9ptimo-libro-capuxedtulo-iv-1}}
...
\hypertarget{sed-y-justicia-suxe9ptimo-libro-capuxedtulo-v-1}{%
\section{Sed y justicia (Séptimo libro, capítulo V)}\label{sed-y-justicia-suxe9ptimo-libro-capuxedtulo-v-1}}
...
\hypertarget{dentro-de-las-fronteras-distorsionadas-suxe9ptimo-libro-capuxedtulo-vi-1}{%
\section{Dentro de las fronteras distorsionadas (Séptimo libro, capítulo VI)}\label{dentro-de-las-fronteras-distorsionadas-suxe9ptimo-libro-capuxedtulo-vi-1}}
...
\hypertarget{la-combinaciuxf3n-de-las-monedas-corrientes-suxe9ptimo-libro-capuxedtulo-vii-1}{%
\section{La combinación de las monedas corrientes (Séptimo libro, capítulo VII)}\label{la-combinaciuxf3n-de-las-monedas-corrientes-suxe9ptimo-libro-capuxedtulo-vii-1}}
...
\hypertarget{las-danzas-de-la-quietud-suxe9ptimo-libro-capuxedtulo-viii-1}{%
\section{Las danzas de la quietud (Séptimo libro, capítulo VIII)}\label{las-danzas-de-la-quietud-suxe9ptimo-libro-capuxedtulo-viii-1}}
...
\hypertarget{el-alza-de-la-vanguardia-fuxfanebre-suxe9ptimo-libro-capuxedtulo-ix-1}{%
\section{El alza de la vanguardia fúnebre (Séptimo libro, capítulo IX)}\label{el-alza-de-la-vanguardia-fuxfanebre-suxe9ptimo-libro-capuxedtulo-ix-1}}
...
\hypertarget{en-horas-de-cuestiones-existenciales-suxe9ptimo-libro-capuxedtulo-x-1}{%
\section{En horas de cuestiones existenciales (Séptimo libro, capítulo X)}\label{en-horas-de-cuestiones-existenciales-suxe9ptimo-libro-capuxedtulo-x-1}}
...
\hypertarget{rumbo-a-la-presunta-verdad-suxe9ptimo-libro-capuxedtulo-xi-1}{%
\section{Rumbo a la presunta verdad (Séptimo libro, capítulo XI)}\label{rumbo-a-la-presunta-verdad-suxe9ptimo-libro-capuxedtulo-xi-1}}
...
\hypertarget{los-delimitados-recorridos-del-paralelismo-residencial-octavo-libro-1}{%
\chapter{Los delimitados recorridos del paralelismo residencial (Octavo libro)}\label{los-delimitados-recorridos-del-paralelismo-residencial-octavo-libro-1}}
...
\hypertarget{el-momento-cuxedclico-del-albergue-marginado-octavo-libro-capuxedtulo-i-1}{%
\section{El momento cíclico del albergue marginado (Octavo libro, capítulo I)}\label{el-momento-cuxedclico-del-albergue-marginado-octavo-libro-capuxedtulo-i-1}}
...
\hypertarget{las-voces-de-la-bipolaridad-protagonista-octavo-libro-capuxedtulo-ii-1}{%
\section{Las voces de la bipolaridad protagonista (Octavo libro, capítulo II)}\label{las-voces-de-la-bipolaridad-protagonista-octavo-libro-capuxedtulo-ii-1}}
...
\hypertarget{el-hambre-del-avaro-oportunista-octavo-libro-capuxedtulo-iii-1}{%
\section{El hambre del avaro oportunista (Octavo libro, capítulo III)}\label{el-hambre-del-avaro-oportunista-octavo-libro-capuxedtulo-iii-1}}
...
\hypertarget{a-partir-de-la-indiferencia-definitiva-octavo-libro-capuxedtulo-iv-1}{%
\section{A partir de la indiferencia definitiva (Octavo libro, capítulo IV)}\label{a-partir-de-la-indiferencia-definitiva-octavo-libro-capuxedtulo-iv-1}}
...
\hypertarget{pensando-en-la-muerte-octavo-libro-capuxedtulo-v-1}{%
\section{Pensando en la muerte (Octavo libro, capítulo V)}\label{pensando-en-la-muerte-octavo-libro-capuxedtulo-v-1}}
...
\hypertarget{la-amnesia-consagratoria-octavo-libro-capuxedtulo-vi-1}{%
\section{La amnesia consagratoria (Octavo libro, capítulo VI)}\label{la-amnesia-consagratoria-octavo-libro-capuxedtulo-vi-1}}
...
\hypertarget{los-consolidados-pasos-del-retocado-mismo-legado-noveno-libro-1}{%
\chapter{Los consolidados pasos del retocado mismo legado (Noveno libro)}\label{los-consolidados-pasos-del-retocado-mismo-legado-noveno-libro-1}}
...
\hypertarget{el-acto-de-decisiuxf3n-y-continuidad-noveno-libro-capuxedtulo-i-1}{%
\section{El acto de decisión y continuidad (Noveno libro, capítulo I)}\label{el-acto-de-decisiuxf3n-y-continuidad-noveno-libro-capuxedtulo-i-1}}
...
\hypertarget{lucidez-terminal-noveno-libro-capuxedtulo-ii-1}{%
\section{Lucidez terminal (Noveno libro, capítulo II)}\label{lucidez-terminal-noveno-libro-capuxedtulo-ii-1}}
...
\hypertarget{el-precario-y-suxfaper-rentable-reemplazo-noveno-libro-capuxedtulo-iii-1}{%
\section{El precario y súper rentable reemplazo (Noveno libro, capítulo III)}\label{el-precario-y-suxfaper-rentable-reemplazo-noveno-libro-capuxedtulo-iii-1}}
...
\hypertarget{el-restaurar-de-la-meseta-cuxedclica-noveno-libro-capuxedtulo-iv-1}{%
\section{El restaurar de la meseta cíclica (Noveno libro, capítulo IV)}\label{el-restaurar-de-la-meseta-cuxedclica-noveno-libro-capuxedtulo-iv-1}}
...
\hypertarget{de-salida-sorpresiva-noveno-libro-capuxedtulo-v-1}{%
\section{De salida sorpresiva (Noveno libro, capítulo V)}\label{de-salida-sorpresiva-noveno-libro-capuxedtulo-v-1}}
...
\hypertarget{la-casa-entera-incompleta-noveno-libro-capuxedtulo-vi-1}{%
\section{La casa entera incompleta (Noveno libro, capítulo VI)}\label{la-casa-entera-incompleta-noveno-libro-capuxedtulo-vi-1}}
...
\hypertarget{la-restauraciuxf3n-gradual-noveno-libro-capuxedtulo-vii-1}{%
\section{La restauración gradual (Noveno libro, capítulo VII)}\label{la-restauraciuxf3n-gradual-noveno-libro-capuxedtulo-vii-1}}
...
\hypertarget{con-lo-buxe1sico-a-disposiciuxf3n-noveno-libro-capuxedtulo-viii-1}{%
\section{Con lo básico a disposición (Noveno libro, capítulo VIII)}\label{con-lo-buxe1sico-a-disposiciuxf3n-noveno-libro-capuxedtulo-viii-1}}
...
\hypertarget{callando-a-los-casi-extintos-creadores-noveno-libro-capuxedtulo-ix-1}{%
\section{Callando a los casi extintos creadores (Noveno libro, capítulo IX)}\label{callando-a-los-casi-extintos-creadores-noveno-libro-capuxedtulo-ix-1}}
...
\hypertarget{entre-la-pacuxedfica-convivencia-reducida-noveno-libro-capitulo-x-1}{%
\section{Entre la pacífica convivencia reducida (Noveno libro, capitulo X)}\label{entre-la-pacuxedfica-convivencia-reducida-noveno-libro-capitulo-x-1}}
...
\hypertarget{por-el-negado-y-cuxe9lebre-parauxedso-noveno-libro-capuxedtulo-xi-1}{%
\section{Por el negado y célebre paraíso (Noveno libro, capítulo XI)}\label{por-el-negado-y-cuxe9lebre-parauxedso-noveno-libro-capuxedtulo-xi-1}}
...
\hypertarget{la-desapariciuxf3n-de-rutina-noveno-libro-capuxedtulo-xii-1}{%
\section{La desaparición de rutina (Noveno libro, capítulo XII)}\label{la-desapariciuxf3n-de-rutina-noveno-libro-capuxedtulo-xii-1}}
...
\hypertarget{el-eco-al-otro-lado-de-la-disminuida-subsistencia-duxe9cimo-libro-1}{%
\chapter{El eco al otro lado de la disminuida subsistencia (Décimo libro)}\label{el-eco-al-otro-lado-de-la-disminuida-subsistencia-duxe9cimo-libro-1}}
...
\hypertarget{la-endeble-seuxf1a-de-cese-duxe9cimo-libro-capuxedtulo-i-1}{%
\section{La endeble seña de cese (Décimo libro, capítulo I)}\label{la-endeble-seuxf1a-de-cese-duxe9cimo-libro-capuxedtulo-i-1}}
...
\hypertarget{la-supervivencia-entre-puentes-duxe9cimo-libro-capuxedtulo-ii-1}{%
\section{La supervivencia entre puentes (Décimo libro, capítulo II)}\label{la-supervivencia-entre-puentes-duxe9cimo-libro-capuxedtulo-ii-1}}
...
\hypertarget{solo-conexiones-minimalistas-duxe9cimo-libro-capuxedtulo-iii-1}{%
\section{Solo conexiones minimalistas (Décimo libro, capítulo III)}\label{solo-conexiones-minimalistas-duxe9cimo-libro-capuxedtulo-iii-1}}
...
\hypertarget{arranques-cuxedclicos-de-un-potencial-hogar-alternativo-unduxe9cimo-libro-1}{%
\chapter{Arranques cíclicos de un potencial hogar alternativo (Undécimo libro)}\label{arranques-cuxedclicos-de-un-potencial-hogar-alternativo-unduxe9cimo-libro-1}}
...
\hypertarget{la-microruxe9plica-dada-a-luz-unduxe9cimo-libro-capuxedtulo-i-1}{%
\section{La microréplica dada a luz (Undécimo libro, capítulo I)}\label{la-microruxe9plica-dada-a-luz-unduxe9cimo-libro-capuxedtulo-i-1}}
...
\hypertarget{arribos-coloridamente-lisos-unduxe9cimo-libro-capuxedtulo-ii-1}{%
\section{Arribos coloridamente lisos (Undécimo libro, capítulo II)}\label{arribos-coloridamente-lisos-unduxe9cimo-libro-capuxedtulo-ii-1}}
...
\hypertarget{emprendiendo-con-firmeza-unduxe9cimo-libro-capuxedtulo-iii-1}{%
\section{Emprendiendo con firmeza (Undécimo libro, capítulo III)}\label{emprendiendo-con-firmeza-unduxe9cimo-libro-capuxedtulo-iii-1}}
...
\hypertarget{alarmas-de-controlada-resoluciuxf3n-unduxe9cimo-libro-capuxedtulo-iv-1}{%
\section{Alarmas de controlada resolución (Undécimo libro, capítulo IV)}\label{alarmas-de-controlada-resoluciuxf3n-unduxe9cimo-libro-capuxedtulo-iv-1}}
...
\hypertarget{el-ocaso-y-amanecer-simultuxe1neo-unduxe9cimo-libro-capuxedtulo-v-1}{%
\section{El ocaso y amanecer simultáneo (Undécimo libro, capítulo V)}\label{el-ocaso-y-amanecer-simultuxe1neo-unduxe9cimo-libro-capuxedtulo-v-1}}
...
Y hablando de términos, la segunda parte de lo incluido trata de ello, pero con otras palabras, la historia más o menos similar en un escenario que pretende ser semejante. El antro estableció leyes propias, normativas que rigen el comportamiento de sus actores y limitan la absoluta libertad del vacío legal o de las aguas internacionales efectivo durante las primeras fechas. Tres pautas básicas marcan el techo de lo aceptado y protegido por la no identificada moderación, que por lo visto no necesitó actuar en lo absoluto desde la inauguración. Parecido a la demora claramente extendida en el difuso lanzamiento más sólido de Temti Nueva, solo que con una urgencia abismalmente menor, ese caso fue ejemplar de una vulnerabilidad tremenda, precisaba que las regulaciones estuvieran más presentes. Aquí es opuesto, si no hubieran llegado quizá lo mismo hubiera sido, aunque teniendo en consideración el factible paquete de novedades que puede estar viniendo, sería de vital importancia, más viendo que la norma número dos a priori hasta el momento no es muy quebrantable que digamos.
...
\hypertarget{lo-uxfanico-que-nunca-cambiuxf3-desenlace-1}{%
\chapter{Lo único que nunca cambió (Desenlace)}\label{lo-uxfanico-que-nunca-cambiuxf3-desenlace-1}}
